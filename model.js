...
//Currentgames.allow({
  ...
  //}
//});
//console.log('asasdasdadLOLOASLDOASLDOALSDOsadfasdf '+Puzzles.find().count());
...
//},
  ...
  //rsvp: function (partyId, rsvp) {
    ...
    //}
  //}
////,  getpuzzle: getpuzzle//function () { alert("ASDASD");} 
//,
  //getPuzzle: function(difficulty){
    //rand = Math.random();
    //result = Puzzles.findOne( { diff : difficulty, random : { $gte : rand } } );
    //if ( result == null ) {
